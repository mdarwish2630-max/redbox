<?php
/* Smarty version 5.7.0, created on 2026-05-16 17:32:17
  from 'file:index.newsfeed.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.7.0',
  'unifunc' => 'content_6a08aa21e97c65_70837622',
...
function content_6a08aa21e97c65_70837622 (\Smarty\Template $_smarty_tpl) {
...
<!-- ========== CATEGORY FILTER BAR ========== -->
<?php if ($_smarty_tpl->getValue('header_categories')) {?>
<div class="rn-feed-categories-wrapper">
  <div class="rn-feed-categories">
    <?php if ($_smarty_tpl->getValue('selected_category')) {?>
      <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
" class="rn-feed-cat-item js-rn-show-all">
        <i class="fa fa-fire"></i>
        <span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("All");?>
</span>
      </a>
    <?php } else { ?>
      <div class="rn-feed-cat-item active js-rn-show-all">
        <i class="fa fa-fire"></i>
        <span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("All");?>
</span>
      </div>
...
?>
      <?php if ($_smarty_tpl->getValue('cat')['category_id'] == $_smarty_tpl->getValue('selected_category')) {?>
        <div class="rn-feed-cat-item active">
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
    <span class="rn-feed-cat-badge"><i class="fa fa-star"></i> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Recommended");?>
</span>
  </div>
  <div class="rn-feed-all-categories" style="display: none;">
    <?php
...
?>
      <?php if ($_smarty_tpl->getValue('cat')['category_id'] == $_smarty_tpl->getValue('selected_category')) {?>
        <div class="rn-feed-all-cat-item active">
          <i class="fa <?php echo $_smarty_tpl->getValue('cat')['category_icon'];?>
"></i>
          <span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('cat')['category_name']);?>
</span>
...
$(document).ready(function() {
  $(document).on('click', '.js-rn-show-all', function(e) {
    e.preventDefault();
    $('.rn-feed-all-categories').slideToggle(200);
  });
});
<?php echo '</script'; ?>
>
