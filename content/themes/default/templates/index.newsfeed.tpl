...
<div class="rn-feed-categories-wrapper">
  <div class="rn-feed-categories">
    {if $selected_category}
      <a href="{$system['system_url']}" class="rn-feed-cat-item js-rn-show-all">
    ...
    {foreach $header_categories as $cat}
      ...
      {else}
        <a href="{$system['system_url']}?category={$cat['category_id']}" class="rn-feed-cat-item">
          <i class="fa {$cat['category_icon']}"></i>
          <span>{__($cat['category_name'])}</span>
        </a>
      {/if}
    {/foreach}
    <span class="rn-feed-cat-badge"><i class="fa fa-star"></i> {__("Recommended")}</span>
  </div>
  <div class="rn-feed-all-categories" style="display: none;">
    {foreach $browse_categories as $cat}
      ...
      {else}
        <a href="{$system['system_url']}?category={$cat['category_id']}" class="rn-feed-all-cat-item">
          <i class="fa {$cat['category_icon']}"></i>
          <span>{__($cat['category_name'])}</span>
        </a>
      {/if}
