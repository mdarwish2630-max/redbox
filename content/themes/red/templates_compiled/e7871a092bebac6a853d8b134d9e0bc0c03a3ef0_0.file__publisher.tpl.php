<?php
/* Smarty version 5.7.0, created on 2026-04-24 19:09:39
  from 'file:_publisher.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.7.0',
  'unifunc' => 'content_69ebbff3c36e43_75754032',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e7871a092bebac6a853d8b134d9e0bc0c03a3ef0' => 
    array (
      0 => '_publisher.tpl',
      1 => 1776802456,
      2 => 'file',
...
function content_69ebbff3c36e43_75754032 (\Smarty\Template $_smarty_tpl) {
...
'>
          ...
          <!-- post browse category -->
          <div class="publisher-meta" data-meta="browse_category">
            <div class="browse-category-selector">
              <p class="rn-category-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Select a category (Required)");?>
</p>
              <div class="rn-category-grid">
                <?php
...
?>
                  <div class="rn-category-pill" data-category-id="<?php echo $_smarty_tpl->getValue('cat')['category_id'];?>
">
                    <i class="<?php echo $_smarty_tpl->getValue('cat')['category_icon'];?>
 rn-category-icon" style="color: <?php echo $_smarty_tpl->getValue('cat')['category_color'];?>
;"></i>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
              ...
              <p class="rn-category-error" style="display: none;"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Please select a category before publishing");?>
</p>
            </div>
          </div>
          <!-- post browse category -->
...
?>
              ...
              <?php if ($_smarty_tpl->getValue('browse_categories')) {?>
                <li class="col-md-6">
                  <div class="publisher-tools-tab js_publisher-tab" data-tab="browse_category" id="publisher-category-tab">
                    <i class="fa fa-tags main-icon mr5" style="font-size: 22px; width: 24px; text-align: center;"></i>
                    <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Category");?>

                    <span class="rn-category-badge" style="display: none;"></span>
                  </div>
                </li>
              <?php }?>
