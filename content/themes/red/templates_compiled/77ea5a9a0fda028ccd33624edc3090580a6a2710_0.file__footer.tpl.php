...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.7.0',
  'unifunc' => 'content_69ebbffb83cc06_71786291',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '77ea5a9a0fda028ccd33624edc3090580a6a2710' => 
    array (
      0 => '_footer.tpl',
      1 => 1776868718,
      2 => 'file',
...
function content_69ebbffb83cc06_71786291 (\Smarty\Template $_smarty_tpl) {
...
>
    ...
    document.addEventListener("click", function(event) {
      if (event.target.matches("#PWAInstallButton")) {
        if (isIos()) {
          alert("<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("To install this app, tap the Share icon and choose Add to Home Screen");?>
");
