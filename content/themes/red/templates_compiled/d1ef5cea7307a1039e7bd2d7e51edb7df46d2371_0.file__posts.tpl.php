...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.7.0',
  'unifunc' => 'content_69ebbff5850373_36086710',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd1ef5cea7307a1039e7bd2d7e51edb7df46d2371' => 
    array (
      0 => '_posts.tpl',
      1 => 1776796184,
      2 => 'file',
...
function content_69ebbff5850373_36086710 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\selfie\\content\\themes\\red\\templates';
?><!-- posts-filter (hidden in RedNote grid mode) -->
<div class="posts-filter x-hidden" style="display:none;">
    ...
    <?php if ($_smarty_tpl->getValue('system')['newsfeed_location_filter_enabled'] && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('page'),array('index','group','event')) && $_smarty_tpl->getValue('view') != "scheduled" && $_smarty_tpl->getValue('view') != "boosted_posts" && (!$_smarty_tpl->getValue('_filter') || $_smarty_tpl->getValue('view') == "watch")) {?>
      ...
      <div class="dropdown-menu dropdown-menu-end countries-dropdown">
        <div class="js_scroller">
          <a class="dropdown-item" href="?country=all"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("All Countries");?>
</a>
          <?php
...
?>
    ...
    <?php } elseif ($_smarty_tpl->getValue('_filter') == "article") {?>
      <?php if ($_smarty_tpl->getValue('user')->_data['can_write_blogs']) {?>
        <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/blogs/new" class="btn btn-sm btn-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Blog");?>
</a>
      <?php }?>
    <?php } elseif ($_smarty_tpl->getValue('_filter') == "product" && !$_smarty_tpl->getValue('_query')) {?>
      <?php if ($_smarty_tpl->getValue('system')['market_enabled'] && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_get'),array('posts_page','posts_group','posts_event'))) {?>
        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-url="posts/product.php?do=create"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Product");?>
</button>
      <?php }?>
    <?php } elseif ($_smarty_tpl->getValue('_filter') == "funding") {?>
      <?php if ($_smarty_tpl->getValue('user')->_data['can_raise_funding'] && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_get'),array('posts_page','posts_group','posts_event'))) {?>
        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-url="posts/funding.php?do=create"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Funding");?>
</button>
      <?php }?>
    <?php } elseif ($_smarty_tpl->getValue('_filter') == "offer") {?>
      <?php if ($_smarty_tpl->getValue('system')['offers_enabled'] && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_get'),array('posts_page','posts_group','posts_event'))) {?>
        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-url="posts/offer.php?do=create"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Offer");?>
</button>
      <?php }?>
    <?php } elseif ($_smarty_tpl->getValue('_filter') == "job") {?>
      <?php if ($_smarty_tpl->getValue('system')['jobs_enabled'] && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_get'),array('posts_page','posts_group','posts_event'))) {?>
        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-url="posts/job.php?do=create"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Job");?>
</button>
      <?php }?>
    <?php } elseif ($_smarty_tpl->getValue('_filter') == "course") {?>
      <?php if ($_smarty_tpl->getValue('user')->_data['can_create_courses'] && !$_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_get'),array('posts_page','posts_group','posts_event'))) {?>
        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-url="posts/course.php?do=create"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Course");?>
</button>
      <?php }?>
    <?php }?>
  </div>
...
<!-- ========== POSTS STREAM - RedNote Grid Layout ========== -->
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
    ...
    <!-- see-more -->
    <div class="rednote-see-more see-more js_see-more js_see-more-infinite" data-get="<?php if ($_smarty_tpl->getValue('_load_more')) {
