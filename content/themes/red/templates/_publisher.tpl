        ...
        <div class="publisher-slider">
          ...
          <div class="publisher-meta" data-meta="browse_category">
            <div class="browse-category-selector">
              <p class="rn-category-label">{__("Select a category (Required)")}</p>
              <div class="rn-category-grid">
                {foreach $browse_categories as $cat}
                  <div class="rn-category-pill" data-category-id="{$cat['category_id']}">
                    <i class="{$cat['category_icon']} rn-category-icon" style="color: {$cat['category_color']};"></i>
                    <span>{__($cat['category_name'])}</span>
                  </div>
                {/foreach}
              </div>
              <input type="hidden" name="browse_category_id" id="browse_category_id" value="">
              <p class="rn-category-error" style="display: none;">{__("Please select a category before publishing")}</p>
            </div>
          </div>
          <!-- post browse category -->
